...
class DeliveriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'article_id' => ['type' => 'index', 'columns' => ['company_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'deliveries_ibfk_1' => ['type' => 'foreign', 'columns' => ['company_id'], 'references' => ['companies', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'price' => 1,
                'created' => '2020-10-19 21:37:12',
                'modified' => '2020-10-19 21:37:12',
            ],
        ];
        parent::init();
    }
